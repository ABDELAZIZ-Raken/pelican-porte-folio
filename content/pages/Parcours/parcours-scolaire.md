...
Après un bac **Général** spécialité **NSI** (**N**umérique et **S**ciences & **I**nformatiques) et **AMC** (**A**nglais, **M**onde **C**ontemporain) avec mention **Assez Bien** au lycée **Saint-Aspais Melun** j'avais la volonté et la détermination de poursuivre dans le domaine de l'informatique. Après m’être renseigné, j’avais identifié les différentes possibilités de poursuite d’études suivantes dans le domaine de l’informatique :
...
- **<u>Options :</u>**
    ...
    <p>    → En l’occurrence, c’était l’option qui m’intéressait le moins, étant davantage intéressé par l’environnement du code.</p>
    - **SLAM** (**S**olutions **L**ogicielles et **A**pplications **M**étiers) → développement d’applications, web, bases de données. 
    <p> → L'option qui me correspond le plus. </p>
...
**2. BTS CIEL** (**C**ybersécurité, **I**nformatique et réseaux, **É**lectronique) OPTION A : Informatique et Réseaux : IR
